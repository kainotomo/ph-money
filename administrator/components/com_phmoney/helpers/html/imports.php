...
abstract class JHtmlImports
{
	...
	public static function status($value = 0, $i, $canChange = true)
	{
		...
		$states = array(
			0 => array('ban text-warning', 'imports.status', 'COM_PHMONEY_PENDING_IMPORT', 'COM_PHMONEY_TOGGLE'),
			1 => array('check-square text-success', 'imports.status', 'COM_PHMONEY_SUCCESSFUL_IMPORT', 'COM_PHMONEY_TOGGLE'),
                        2 => array('exclamation-triangle text-danger', 'imports.status', 'COM_PHMONEY_FAILED_IMPORT', 'COM_PHMONEY_TOGGLE'),
		);
