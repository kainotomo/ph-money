 ...
 *
 */
class SplitController extends FormController
{
	/**
	 * Constructor.
	 *
	...
	public function __construct($config = array(), MVCFactoryInterface $factory = null, $app = null, $input = null)
	{
		...
		if ($this->input->get('return') == 'splits')
		{
			...
			$this->view_item = 'split&return=splits';
		}
	}
	...
	protected function allowAdd($data = array())
	{
		...
		if ($categoryId)
		{
			...
			$allow = \JFactory::getUser()->authorise('core.create', 'com_phmoney.category.' . $categoryId);
		}
	...
	protected function allowEdit($data = array(), $key = 'id')
	{
		...
		if ($user->authorise('core.edit', 'com_phmoney.split.' . $recordId))
		{
			return true;
		}

		// Check edit own on the record asset (explicit or inherited)
		if ($user->authorise('core.edit.own', 'com_phmoney.split.' . $recordId))
		{
