...
namespace Joomla\Component\Phmoney\Administrator\View\Prices;
...
/**
 * View class for a list of prices.
 *
...
class HtmlView extends BaseHtmlView {
        ...
        public function display($tpl = null) {
                if ($this->getLayout() !== 'modal') {
                        PhmoneyHelper::addSubmenu('prices');
                }
                ...
                if ($this->getLayout() !== 'modal') {
                        ...
                        // In price associations modal we need to remove language filter if forcing a language.
        ...
        protected function addToolbar() {
                ...
                ToolbarHelper::title(Text::_('COM_PHMONEY'), 'stack price');
        ...
        protected function addButtonbar() {
                ...
                if ($canDo->get('core.create') || count($user->getAuthorisedCategories('com_phmoney', 'core.create')) > 0) {
                        $html[] = $standarButtonLayout->render(Array('task' => 'price.add', 'class' => 'btn-outline-success', 'alt' => 'JTOOLBAR_NEW', 'icon' => 'fa-plus', 'list' => false, 'group' => false));
                        $html[] = $standarButtonLayout->render(Array('task' => 'prices.retrieve', 'class' => 'btn-outline-primary', 'alt' => 'COM_PHMONEY_RETRIEVE', 'icon' => 'fa-download', 'list' => false, 'group' => false, 'confirm' => true));
                }

                if ($canDo->get('core.delete') || count($user->getAuthorisedCategories('com_phmoney', 'core.delete')) > 0) {
                        $html[] = $standarButtonLayout->render(Array('task' => 'prices.delete', 'class' => 'btn-outline-danger', 'alt' => 'JTOOLBAR_DELETE', 'icon' => 'fa-trash', 'list' => true, 'group' => false, 'confirm' => true));
                }
