...
namespace Joomla\Component\Phmoney\Administrator\View\Imports;
...
class HtmlView extends BaseHtmlView
{
        ...
        protected function addButtonbar()
        {
                ...
                if ($canDo->get('core.create') || count($user->getAuthorisedCategories('com_phmoney', 'core.create')) > 0) {
                        $html[] = $standarButtonLayout->render(Array('task' => 'imports.import_selected', 'class' => 'btn-outline-primary', 'alt' => 'COM_PHMONEY_IMPORT', 'icon' => 'fa-upload', 'list' => true, 'group' => false, 'confirm' => true));
                        $html[] = $standarButtonLayout->render(Array('task' => 'imports.estimate', 'class' => 'btn-outline-secondary', 'alt' => 'COM_PHMONEY_ESTIMATE', 'icon' => 'fa-cog', 'list' => false, 'group' => false, 'confirm' => true));
                        $html[] = $standarButtonLayout->render(Array('task' => 'imports.download_prices', 'class' => 'btn-outline-secondary', 'alt' => 'COM_PHMONEY_DOWNLOAD_PRICES', 'icon' => 'fa-download', 'list' => false, 'group' => false, 'confirm' => true));
                        $html[] = $standarButtonLayout->render(Array('task' => 'import.add', 'class' => 'btn-outline-success', 'alt' => 'JTOOLBAR_NEW', 'icon' => 'fa-plus', 'list' => false, 'group' => false));
                        /*
                          $toolbarButtons = [];
                          $toolbarButtons[] = Array('task' => 'imports.import_selected', 'class' => 'btn-outline-primary', 'alt' => 'COM_PHMONEY_IMPORT', 'icon' => 'fa-upload', 'list' => true, 'group' => false, 'confirm' => true);
                          $toolbarButtons[] = Array('task' => 'imports.import_all', 'class' => 'btn-outline-primary', 'alt' => 'COM_PHMONEY_IMPORT_ALL', 'icon' => 'fa-upload', 'list' => false, 'group' => true, 'confirm' => true);
                ...
                if ($canDo->get('core.delete')) {
                        $html[] = $standarButtonLayout->render(Array('task' => 'imports.delete', 'class' => 'btn-outline-danger', 'alt' => 'COM_PHMONEY_DELETE', 'icon' => 'fa-trash', 'list' => true, 'group' => false, 'confirm' => true));
                }
