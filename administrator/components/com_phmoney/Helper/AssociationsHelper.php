...
use Joomla\Component\Phmoney\Site\Helper\AssociationHelper;

/**
 * Description of AssociationsHelper
 *
...
class AssociationsHelper extends AssociationExtensionHelper {
         ...
         *
         */
        protected $extension = 'com_phmoney';
         ...
         *
         */
        protected $itemTypes = array('portfolio', 'category');
        ...
        public function getAssociations($typeName, $id) {
                ...
                $associations = Associations::getAssociations(
                                $this->extension, $type['tables']['a'], $context, $id, 'id', 'alias', $catidField
                );
