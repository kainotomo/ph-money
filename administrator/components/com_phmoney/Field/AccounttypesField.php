...
/**
 * Description of AccounttypesField
 *
 * @author KAINOTOMO PH LTD <info@kainotomo.com>
 */
class AccounttypesField extends Field\ListField{
        ...
        public function getOptions() {
                ...
                $options = array_merge(parent::getOptions(), PhmoneyHelper::getAccountTypes());
                return $options;
        }
}
