...
<form action="<?php echo JRoute::_('index.php?option=com_phmoney&view=split&layout=edit&id=' . $this->state->get('uid')); ?>" method="post" name="adminForm" id="item-form" class="form-validate" enctype="multipart/form-data">
