...
<form action="<?php echo JRoute::_('index.php?option=com_phmoney&view=portfolio&layout=edit&id=' . $this->state->get('portfolio.id')); ?>" method="post" name="adminForm" id="item-form" class="form-validate" enctype="multipart/form-data">
