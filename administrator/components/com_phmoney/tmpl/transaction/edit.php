...
<div class="card">
    ...
    <form action="<?php echo JRoute::_('index.php?option=com_phmoney&view=transaction&layout=edit&id=' . $this->state->get('transaction.id')); ?>" method="post" name="adminForm" id="item-form" class="form-validate" enctype="multipart/form-data">
...
<div id="hidden-input">
    <input type="hidden" name="task" value="" onload="PHMONEY.trx_loaded();">
