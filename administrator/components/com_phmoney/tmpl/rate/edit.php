...
<form action="<?php echo JRoute::_('index.php?option=com_phmoney&view=rate&layout=edit&id=' . $item->id); ?>" method="post" name="adminForm" id="item-form" class="form-validate" enctype="multipart/form-data">
